...
{
    internal class FireLuigiAttack : ISprite
    {
        ...
        public FireLuigiAttack(Luigi luigi)
        {
            this.luigi = luigi;

            // if direction is positive then the sprite will turn right (left by default)
            leftSpriteFrames = new Rectangle[] { new Rectangle(209, 298, 17, 28), new Rectangle(227, 298, 17, 28) };
