...
{
    internal class FireCrouchingLuigi : ISprite
    {
        private Luigi luigi;
        ...
        public FireCrouchingLuigi(Luigi luigi)
        {
            this.luigi = luigi;
            spriteFrames = new Rectangle[] { new Rectangle(55, 265, 17, 28)};
        ...
        public void Draw(SpriteBatch spriteBatch, ContentManager Content)
        {
            ...
            destination = new Rectangle((int)luigi.position.X, (int)luigi.position.Y + 5, 34, 56);
