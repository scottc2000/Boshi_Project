...
{
    internal class FireRunAroundSprite : ISprite
    {
        ...
        public FireRunAroundSprite(Luigi luigi)
        {
            this.luigi = luigi;

            // if direction is positive then the sprite will turn right (left by default)
            leftSpriteFrames = new Rectangle[] { new Rectangle(19, 264, 17, 28), new Rectangle(37, 264, 17, 28) };
