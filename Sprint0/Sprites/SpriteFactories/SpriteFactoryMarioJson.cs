...
// This file needs to be fixed due to null reference errors - put on hold
namespace Sprint0.Sprites.SpriteFactories
{
    public class SpriteFactoryMarioJson
    {
        ...
        private static SpriteFactoryMarioJson instance = new SpriteFactoryMarioJson();

        public static SpriteFactoryMarioJson Instance
        {
            get
            {
                return instance;
        ...
        public void LoadTextures(ContentManager content)
        {
           ...
           // string fileName = "SpriteJSONSMarioJSON.json";
