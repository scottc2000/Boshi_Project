...
namespace Sprint0.Collision
{
    ...
    public class CollisionDictionraryRegister
    {
        ...
        public void generate()
        {
            ...
            collisions.marioBlock.Add(new Tuple<Mario, List<IBlock>, CollisionDictionary.Side>(sprint.objects.mario, sprint.objects.Blocks, CollisionDictionary.Side.Right), new Tuple<ICommand, ICommand>(new CMarioStuckX(sprint), null));
            collisions.marioBlock.Add(new Tuple<Mario, List<IBlock>, CollisionDictionary.Side>(sprint.objects.mario, sprint.objects.Blocks, CollisionDictionary.Side.Top), new Tuple<ICommand, ICommand>(new CMarioStuckY(sprint), null));
            collisions.marioBlock.Add(new Tuple<Mario, List<IBlock>, CollisionDictionary.Side>(sprint.objects.mario, sprint.objects.Blocks, CollisionDictionary.Side.Bottom), new Tuple<ICommand, ICommand>(new CMarioStuckY(sprint), null));

            // mario enemy collision
            collisions.marioEnemy.Add(new Tuple<Mario, List<IEnemies>, CollisionDictionary.Side>(sprint.objects.mario, sprint.objects.Enemies, CollisionDictionary.Side.Left), new Tuple<ICommand, ICommand>(new CMarioTakeDamage(sprint), null));
            collisions.marioEnemy.Add(new Tuple<Mario, List<IEnemies>, CollisionDictionary.Side>(sprint.objects.mario, sprint.objects.Enemies, CollisionDictionary.Side.Right), new Tuple<ICommand, ICommand>(new CMarioTakeDamage(sprint), null));
